        ...
        <div class="pt-grid">
            ...
            <div class="pt-card pt-card-photo">
                ...
                <div class="pt-card-overlay">
                    ...
                    <a href="<?php echo esc_url( home_url( '/telconnect-parking' ) ); ?>" class="pt-btn-primary">Ver más detalles</a>
                </div>
            </div>
            ...
            <div class="pt-card pt-card-mockup">
                ...
                <div class="pt-card-text">
                    ...
                    <a href="<?php echo esc_url( home_url( '/tienda' ) ); ?>" class="pt-btn-outline">Comprar una máquina</a>
                </div>
            </div>
        </div>
    </div>
