        ...
        <div class="pt-grid">
            ...
            <div class="pt-card pt-card-photo">
                ...
                <div class="pt-card-overlay">
                    ...
                    <a href="<?php echo esc_url( home_url( '/telconnect-parking' ) ); ?>" class="pt-btn-primary"><span class="btn-label-mask"><span class="btn-label">Ver más detalles</span><span class="btn-label-ghost" aria-hidden="true">Ver más detalles</span></span></a>
                </div>
            </div>
