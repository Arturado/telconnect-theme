    ...
    <div class="dp-container">
        ...
        <div class="dp-features-strip">
            <div class="dp-feature-item">
                <span class="dp-feature-icon dp-icon-clock"></span>
                <div>
            ...
            <div class="dp-feature-item">
                <span class="dp-feature-icon dp-icon-bolt"></span>
                <div>
            ...
            <div class="dp-feature-item">
                <span class="dp-feature-icon dp-icon-truck"></span>
                <div>
            ...
            <div class="dp-feature-item">
                <span class="dp-feature-icon dp-icon-phone"></span>
                <div>
        ...
        <div class="dp-cta-banner">
            ...
            <a href="<?php echo tc_whatsapp_url(); ?>" target="_blank" rel="noopener" class="btn btn-primary-blue">Asesórate por WhatsApp</a>
        </div>
    </div>
</section>